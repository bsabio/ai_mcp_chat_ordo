...
export default async function LibraryIndexPage() {
  ...
  return (
    <div className="shell-page library-page-shell">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-(--space-10) px-(--container-padding) py-(--space-12) sm:py-(--space-16)">
